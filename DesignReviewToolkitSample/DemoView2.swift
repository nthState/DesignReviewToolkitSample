...
.modifier(DesignReviewToolkit.CustomAccessibilityModifier(accessibility: [DesignReviewToolkit.AccessibilityType.accessibilityHint: "\"Like this game and move to the next one.\"", DesignReviewToolkit.AccessibilityType.accessibilityLabel: "\"Like game\""], style: [:], depth: 2))
        ...
        .font(.headline)
        .padding(.bottom)
.modifier(DesignReviewToolkit.CustomAccessibilityModifier(accessibility: [:], style: [DesignReviewToolkit.StyleType.font: ".headline", DesignReviewToolkit.StyleType.padding: ".bottom"], depth: 1))
...
.modifier(DesignReviewToolkit.CustomAccessibilityModifier(accessibility: [DesignReviewToolkit.AccessibilityType.accessibilityElement: ".ignore", DesignReviewToolkit.AccessibilityType.accessibilityLabel: "\"Rated \\(game.rating) out of 5 stars.\""], style: [:], depth: 2))
...
.modifier(DesignReviewToolkit.CustomAccessibilityModifier(accessibility: [DesignReviewToolkit.AccessibilityType.accessibilityHint: "\"Swipe right to like, swipe left to skip, or use the Like and Skip buttons below.\"", DesignReviewToolkit.AccessibilityType.accessibilityAddTraits: ".isButton", DesignReviewToolkit.AccessibilityType.accessibilityElement: ".ignore", DesignReviewToolkit.AccessibilityType.accessibilityLabel: "\"\\(game.title), \\(game.genre) on \\(game.platform). \\(game.shortDescription). Rated \\(game.rating) out of 5 stars.\""], style: [DesignReviewToolkit.StyleType.padding: "8", DesignReviewToolkit.StyleType.background: "RoundedRectangle(cornerRadius: 24, style: .continuous)\n        .fill(Color(uiColor: .secondarySystemBackground))\n        .shadow(radius: 6, y: 4)"], depth: 0))
...
struct TagLabel: View {
  ...
  var body: some View {
    Text(text)
      ...
      .clipShape(Capsule())
.modifier(DesignReviewToolkit.CustomAccessibilityModifier(accessibility: [DesignReviewToolkit.AccessibilityType.text: "text"], style: [DesignReviewToolkit.StyleType.font: ".headline.weight(.bold)", DesignReviewToolkit.StyleType.background: "text == \"LIKE\" ? Color.green.opacity(0.8) : Color.red.opacity(0.8)", DesignReviewToolkit.StyleType.padding: "8"], depth: 0))
